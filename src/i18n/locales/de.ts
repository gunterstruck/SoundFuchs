...
export const de: TranslationDict = {
  ...
  hoerlupe: {
    ...
    auswahlHinweis:
      'Ziehe einen Rahmen um das auffällige Muster. Pfeiltasten verschieben ihn, Umschalt + Pfeiltasten ändern seine Größe. Abgespielt wird eine bearbeitete Hörhilfe aus dem Unterschied.',
    ...
    auswahlBeschreibung: 'Auswahl · {{vonZeit}}–{{bisZeit}} s · {{vonHz}}–{{bisHz}}',
    laeuft: 'Läuft: {{quelle}}',
  },
  site: {
    machines: 'Maschinen',
