/**
 * SOUNDFUCHS - German (Deutsch) Translations
 *
...
export const de: TranslationDict = {
  ...
  maschine: {
    rundeFertig: '✓ Runde fertig — {{anzahl}} Maschinen an diesem Standort geprüft',
    ...
    lageLaeuft: 'Läuft …',
    fingerabdruckFertig: 'Normalzustand ist bereit',
    fingerabdruckAlt: 'Akustischer Fingerabdruck dieser Maschine',
    aktionGegenprobe: 'Jetzt Gegenprobe machen',
    ...
    hinweisGegenprobe:
      'Nimm dieselbe Maschine noch einmal auf — so siehst du sofort, wie genau der Vergleich ist.',
    ...
    ergebnisAbweichung: 'Die Messung klingt anders als der Normalzustand.',
    ergebnisAehnlich: 'Die Messung klingt wie der Normalzustand.',
    ...
    keinTonGespeichert: 'Für diese Prüfung wurde kein Ton gespeichert.',
  ...
  klangbild: {
    quelleFoto: '📷 Foto',
    fotoAlt: 'Gespeichertes Positionsbild dieser Maschine',
    fotoHinweis: 'So stand das Gerät beim Anlernen — halte es wieder so.',
    ...
    ziehen: 'Tippen zeigt das Gebirge · Ziehen greift eine Stelle heraus.',
    quelleIris: 'Iris',
  ...
  hoerlupe: {
    ...
    hervorhebungAus: 'Originalmessung',
    hervorhebungDeutlich: 'Deutlich',
    hervorhebungStark: 'Stark',
    hervorhebungHinweis: 'Bearbeitete Hörhilfe. Originalmessung und Bewertung bleiben unverändert.',
    hervorhebungDeutlichLaeuft: 'Messung · Unterschied deutlich hervorgehoben',
    hervorhebungStarkLaeuft: 'Messung · Unterschied stark hervorgehoben',
    vergleichTeilen: '📤 Mit Fachmann teilen',
    vergleichWirdVorbereitet: 'WAV-Dateien werden vorbereitet …',
    vergleichTitel: 'SoundFuchs Hörvergleich · {{name}}',
    vergleichText:
      'Originalmessung und bearbeitete Hörhilfe ({{stufe}}). Die Hörhilfe verändert nicht die Bewertung.',
    vergleichGeteilt: 'Hörvergleich wurde zum Teilen übergeben.',
    vergleichHeruntergeladen: 'Originalmessung und Hörhilfe wurden als WAV heruntergeladen.',
    vergleichFehlgeschlagen: 'Hörvergleich konnte nicht ausgegeben werden.',
    ...
    auswahlAchseFrequenz: '↕ Frequenz',
    auswahlAchseZeit: 'Zeit →',
    auswahlAnhoeren: '🔊 Auswahl anhören',
    ...
    staerkeDeutlich: 'Deutlich erhöht',
    staerkeStark: 'Stark erhöht',
    staerkeAnteil: 'Vor Verstärkung: {{prozent}} % Differenz-RMS der Messung.',
    staerkeVergleich:
      'Vor Verstärkung: {{prozent}} % Differenz-RMS · {{faktor}}× innere Schwankung des Normalzustands.',
    staerkeHinweis:
  ...
  site: {
    ...
    countMachineOne: '1 Maschine',
    stateNoneChecked: 'noch keine geprüft',
    stateDeviating: '{{n}} klingen anders als ihr Normalzustand',
    stateDeviatingOne: '1 klingt anders als ihr Normalzustand',
    stateUnchecked: '{{n}} ohne Normalzustand',
    stateUncheckedOne: '1 ohne Normalzustand',
    stateAllFine: 'alle klingen wie ihr Normalzustand',
  ...
  schale: {
    ...
    nearby: {
      title: 'In der Nähe',
      originMap: '🗺 Kartenmitte',
      originGps: '📍 Mein Standort',
      visible: '{{count}} sichtbar',
      filtered: 'gefiltert',
      unchecked: 'ungeprüft',
      empty: 'Hier in der Nähe liegt kein Standort.',
      gpsWaiting: 'Standort wird gesucht …',
      gpsDenied: 'Standort nicht freigegeben',
  ...
  // ============================================================================
  modals: {
    unsuitableSignal: 'Signal nicht geeignet',
  ...
  map: {
    ...
    emptyTitle: 'Starte mit deiner ersten Maschine',
  ...
  customers: {
    ...
    createButton: 'Standort speichern',
    created: 'Standort „{{name}}“ wurde angelegt.',
    createError: 'Der Standort konnte nicht gespeichert werden.',
    gpsButton: 'Aktuellen Standort verwenden',
    gpsUpdate: 'GPS-Position aktualisieren',
    gpsLocating: 'Standort wird bestimmt …',
    gpsReady: 'Position übernommen · etwa {{accuracy}} m genau.',
    gpsErrorPermission: 'Standortzugriff wurde nicht erlaubt. Nutze stattdessen die PLZ.',
    gpsErrorUnavailable: 'Die Position ist gerade nicht verfügbar. Nutze stattdessen die PLZ.',
    gpsErrorTimeout:
      'Die Standortbestimmung dauerte zu lange. Bitte erneut versuchen oder PLZ nutzen.',
    gpsPrivacy: 'SoundFuchs speichert die Koordinaten nur auf diesem Gerät.',
    orPostcode: 'oder per PLZ',
    plzOrGpsRequired: 'Bitte GPS verwenden oder eine fünfstellige Postleitzahl eingeben.',
  ...
  identify: {
    ...
    emptyGuide: {
      title: 'So funktioniert SoundFuchs',
    ...
    errors: {
      createFailed: 'Maschine konnte nicht angelegt werden.',
      invalidReferenceUrl: 'Ungültige Adresse für die Referenzdatenbank.',
  ...
  reference: {
    ...
    errors: {
      recordingTooShort:
        'Aufnahme zu kurz: {duration} s. Nach {warmup} s Vorlauf bleibt zu wenig übrig – mindestens {minDuration} s aufnehmen.',
      trainingDataTooShort:
        'Nutzbarer Teil zu kurz: {duration} s, nötig sind {minDuration} s. Insgesamt mindestens {totalMinDuration} s aufnehmen.',
      baselineScoreTooLow:
        'Die Referenz stimmt nur zu {baselineScore} % mit sich selbst überein; nötig sind {minScore} %. Bitte in ruhigerer Umgebung neu aufnehmen.',
      tooShort:
    ...
    success: {
      downloadPrompt: 'Datei wird heruntergeladen.',
      modelTrained:
  ...
  diagnose: {
    ...
    display: {
      ...
      reference: 'Normalzustand',
      waitingForSignal: 'Warte auf Signal...',
      spectrumReveal: '👁 Spektrum ansehen',
      spectrumHide: 'Spektrum ausblenden',
      listenSectionLabel: 'Hör-Lupe',
      listenSectionHint:
        'Vergleiche Normalzustand und Messung – oder höre nur, was neu hinzugekommen ist.',
      listenReference: '🔊 Normalzustand',
      ...
      irisReference: 'Normalzustand',
      irisMeasurement: 'Messung',
      deviationFrequencyLabel: '⚠ Abweichende Hauptfrequenz: ~{{freq}}',
      operatingPointWarning:
        '⚠ Anderer Betriebspunkt als im Normalzustand (dominanter Ton ≈{{refFreq}} → {{measFreq}}). Eine geringere Übereinstimmung kann an geänderter Drehzahl/Last liegen statt an einem Defekt.',
      ...
      listenDifferenceTooShort: 'Die Aufnahmen sind zu kurz, um den Unterschied zu berechnen.',
      listenTune: '🎧 Auf hörbaren Bereich',
      listenTuneResult: '🎧 {{peak}} → {{target}}',
      listenTuneClamped:
        'Faktor begrenzt, damit ein Takt hörbar bleibt — die Zielfrequenz wird deshalb nicht ganz erreicht.',
      listenTuneExact:
        'Größter Unterschied auf den Bereich gezogen, in dem das Ohr am besten auflöst.',
      spectrumTitle: 'Frequenzvergleich (Normalzustand ↔ Messung)',
      spectrumReference: 'Normalzustand',
  ...
  settings: {
    ...
    share: {
      title: 'SoundFuchs Datenbank-Backup',
  ...
  // ============================================================================
  hardware: {
    sampleRateLow: 'Abtastrate zu niedrig ({sampleRate} Hz)',
    currentSampleRate: 'Aktuell: {sampleRate} Hz',
    recommendedSampleRate: 'Empfohlen: mindestens {minRate} Hz',
    microphoneId: 'Mikrofon {id}',
    optimizedForDiagnosis: '{label} – für die Prüfung geeignet',
  ...
  nfc: {
    ...
    // einzige Stelle, an der SoundFuchs aus einer Einzelmessung etwas Gemeinsames
  ...
  about: {
    ...
    ipTable: {
      headers: {
        ...
        soundfuchsDiff: 'Abgrenzung von SoundFuchs',
      },
      rows: {
        '0': {
          reference:
          ...
          soundfuchsDiff:
            'SoundFuchs wertet lokal aus, ohne SoundFuchs-Analyse-Cloud, zentrale Messdatenbank oder Befundung',
        },
        '1': {
        ...
        '2': {
          ...
          soundfuchsDiff:
            'SoundFuchs nutzt GMIA-ähnliche Mathematik ausschließlich für Nicht-Sprache und lokale Vergleiche',
        },
        '3': {
          ...
          soundfuchsDiff:
            'SoundFuchs erstellt lokale Referenzprofile und Ähnlichkeitswerte, trainiert aber kein eigenes neuronales Netz und leitet keine Schadensursache ab',
        },
        '4': {
          ...
          soundfuchsDiff: 'Unterschiedliche Domäne und Signalart, nicht verwandt',
        },
        '5': {
    ...
    parallelComparisonApplication:
      '<strong>Anwendung:</strong><ul><li>Aufnahmen von mehreren baugleichen Maschinen (z. B. in einer Produktionshalle) werden erstellt</li><li>SoundFuchs berechnet die akustische Ähnlichkeit zwischen den Maschinen</li><li>Maschinen, deren Geräuschsignatur deutlich von der Gruppe abweicht, werden sichtbar</li></ul>',
    ...
    parallelComparisonHint:
      '<strong>Hinweis:</strong> SoundFuchs entscheidet nicht, welche Maschine defekt ist oder welche den „Sollzustand" darstellt. Es zeigt ausschließlich <strong>relative Abweichungen</strong> innerhalb der Gruppe. Die Bewertung, ob eine abweichende Maschine weiter untersucht werden sollte, liegt beim Nutzer.',

    // NFC Section
    nfcTitle: 'NFC-basierter Sofortzugang und kontextbasierter Vergleich',
    nfcIntro:
      'SoundFuchs unterstützt den <strong>Einsatz von NFC-Tags</strong> an Maschinen, um den Zugang zur App zu vereinfachen und optional einen maschinenspezifischen Kontext bereitzustellen.',
    ...
    checkFound: 'Neue Fassung gefunden. Mit „Jetzt aktualisieren" startet SoundFuchs neu.',
  ...
  spectro3d: {
    ...
    compareScale: '⚖ Stärke vergleichen',
    detailScale: '🔎 Details sichtbar',
    computing: '… rechne …',
  ...
  share: {
    ...
    resultFooter: 'SoundFuchs Klang-Prüfung',
  ...
  temporalEvents: {
    ...
    densityMissing: 'Erwarteter Takt fehlt: deutlich weniger Ereignisse als in der Referenz.',
    densityExcess: 'Deutlich mehr Ereignisse als in der Referenz (Fremdgeräusche?).',
    ...
    recommendSwitched: 'Zeitmuster-Engine aktiviert — sie gilt für neu angelernte Referenzen.',
  },
  ...
  resultAmpel: {
    ...
    // absichtlich, was SoundFuchs LEISTET, nicht nur was es nicht tut: „ich
  ...
  report: {
    ...
    colDate: 'Datum',
    footer: 'Erstellt mit SoundFuchs · Akustische Maschinenprüfung',
