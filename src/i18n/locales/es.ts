...
export const es: TranslationDict = {
  ...
  sheet: {
    ...
    customerData: 'Clientes: ejemplos e importación',
  },
  ...
  customers: {
    ...
    namePlaceholder: 'p. ej. Müller Guss GmbH',
    ...
    nameRequired: 'Introduce el nombre de la empresa del cliente.',
    plzInvalid: 'Introduce un código postal alemán de cinco cifras.',
    plzFound: '{{ort}} — tomado del código postal.',
    plzUnknown: 'Este código postal es desconocido. El cliente se crea, pero sin punto en el mapa.',
    demoTitle: 'Datos de ejemplo',
    demoDescription:
      'Unos 100 clientes inventados, repartidos por toda Alemania, cada uno con una máquina sin referencia. Para demostraciones: los datos reales permanecen intactos.',
    demoLoad: 'Cargar datos de ejemplo',
    demoRemove: 'Eliminar datos de ejemplo',
    demoCount: '{{count}} clientes de ejemplo cargados',
    demoLoaded: '{{count}} clientes de ejemplo creados',
    demoRemoved: '{{count}} clientes de ejemplo eliminados',
    demoError: 'No se pudieron procesar los datos de ejemplo.',
    importTitle: 'Importar lista de clientes',
    importDescription:
    ...
    importSummary:
      '{{angelegt}} clientes creados, {{maschinen}} máquinas, {{uebersprungen}} omitidos, {{fehler}} filas inválidas',
    importNoColumns:
      'El archivo no tiene columna "Nombre" ni "Código postal" — no se importó nada.',
    importError: 'No se pudo importar la lista de clientes.',
  },
  ...
  nfc: {
    ...
    customerIdDescription:
      'Este ID determina qué datos de referencia se cargan al escanear la etiqueta NFC. Los datos se cargan automáticamente desde GitHub Pages.',
  ...
  about: {
    ...
    nfcTagDescription:
      '<strong>Etiqueta NFC en la máquina:</strong> una etiqueta NFC colocada en la carcasa o el punto de acceso puede contener la siguiente información:<ul><li>URL de la PWA de SoundFuchs (inicio directo de la app en el navegador)</li><li>ID de máquina para identificación automática</li><li>Opcional: referencia a datos de referencia específicos del cliente (URL a un archivo JSON)</li></ul>',
    nfcInstantAccess:
    ...
    nfcDataPrivacyImportant:
      '<strong>Importante:</strong> los datos de referencia <strong>no se almacenan en una nube de SoundFuchs</strong>. Se proporcionan:<ul><li>En la <strong>red local</strong> del operador (p. ej., servidor de intranet)</li><li>En un <strong>entorno propio del cliente</strong> (p. ej., GitHub Pages, servidor web propio)</li><li>Como un <strong>archivo JSON estático</strong> accesible mediante una URL HTTPS</li></ul>',
