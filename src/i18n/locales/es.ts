...
export const es: TranslationDict = {
  ...
  sheet: {
    groupLearn: 'Descubrir',
    miniTraining: 'Mini lecciones · 5 demos en vivo',
    ...
    tool: 'Herramienta de análisis',
  },
  showcase: {
    heading: 'SoundFuchs en cinco lecciones breves',
    intro: 'El zorro le guía por la aplicación real. Elija el proceso que desea ver.',
    safeHint: 'Sonidos sintéticos · sus datos no se modifican',
    close: 'Cerrar',
    stop: 'Finalizar',
    recommended: 'Recomendado',
    aboutSeconds: 'aprox. {{seconds}} s',
    completed: 'Mini lección finalizada',
    interrupted: 'Mini lección interrumpida',
    failure: 'La demostración no pudo completarse. Se ha restaurado el estado anterior.',
    next: 'A continuación',
    overview: 'Selección',
    startNext: 'Iniciar siguiente',
    retry: 'Reintentar',
    cancelled: 'Demostración finalizada',
    missingTarget: 'El siguiente paso no estaba disponible: {{target}}',
    unknownAction: 'Paso de demostración desconocido: {{action}}',
    demo: {
      site: 'Lección SoundFuchs · Taller',
      city: 'Modo de demostración',
      machine: 'Bomba de demostración 1',
    },
    core: {
      title: 'Normal hoy, comparar después',
      blurb: 'Estado normal, contraprueba e historial en un solo proceso.',
      intro:
        'SoundFuchs necesita primero una referencia: esta máquina concreta cuando funciona normalmente según su criterio.',
      reference:
        'En el uso real, mantenga el teléfono diez segundos en la misma posición. La lección acelera la grabación.',
      fingerprint:
        'El estado normal se convierte en la huella acústica de esta máquina, localmente en este dispositivo.',
      countercheck:
        'En la próxima visita basta una contraprueba: misma posición y un estado de funcionamiento comparable.',
      result:
        'La medición suena diferente del estado normal. SoundFuchs no nombra una causa; documenta el cambio.',
      history:
        'Cada comprobación queda en el historial y convierte un sonido aislado en una evolución trazable.',
    },
    difference: {
      title: 'Ver y oír la diferencia',
      blurb: 'Comprender la imagen sonora, la lupa auditiva y la comparación 3D.',
      intro: 'Un porcentaje es solo el comienzo. Importa dónde y cómo ha cambiado el sonido.',
      sources: 'Cambie aquí entre estado normal, medición, diferencia y huella compartida.',
      listen:
        'La lupa auditiva resalta el contraste para oír lo que puede quedar oculto en el original.',
      threeD:
        'El relieve 3D muestra la misma comparación por frecuencia, tiempo e intensidad; no es otra evaluación.',
      limit:
        'SoundFuchs hace visible y audible una desviación. Una persona decide si es técnicamente relevante.',
    },
    import: {
      title: 'Importar un vídeo del móvil',
      blurb: 'Extraer el audio, examinarlo y continuar con honestidad.',
      intro:
        '¿El vídeo ya está en el móvil? Importar toma la pista de audio sin exigir antes un formulario.',
      preview:
        'El fragmento elegido aparece en la imagen sonora real. Vídeo y audio se procesan localmente.',
      noReference:
        'Sin un estado normal anterior no hay comparación honesta ni porcentaje de desviación.',
      honest:
        'Aun así puede examinar, escuchar y preparar la grabación como observación neutral, sin diagnóstico inventado.',
    },
    recognition: {
      title: '¿Conoce SoundFuchs esta máquina?',
      blurb: 'Buscarla entre referencias locales o admitir que no.',
      intro:
        'El reconocimiento no busca averías. Solo pregunta si el sonido coincide con una máquina ya conocida en este dispositivo.',
      match:
        'El sonido coincide claramente con la bomba de demostración. Solo entonces se abre la máquina correcta.',
      boundary:
        'Si no es concluyente, SoundFuchs muestra candidatos o indica «desconocida», sin inventar una máquina.',
    },
    briefing: {
      title: 'Entregar bien una observación',
      blurb: 'Preparar localmente el paquete acústico y la orden de trabajo.',
      intro: 'Tras comparar, el informe reúne las grabaciones y el punto auditivo marcado.',
      context:
        'Añada solo el contexto necesario: situación, posición en el objeto y su observación.',
      local: 'El paquete se crea íntegramente en el navegador. SoundFuchs no ha subido nada.',
      handoff:
        'Solo su clic consciente crea el ZIP y la orden de trabajo. Usted decide dónde enviarlos.',
    },
  },
  blatt: {
    tabStandort: 'Historial',
    tabZweiD: '2D',
    tabDreiD: '3D',
    tabBriefing: 'Informe',
    nochNichts: 'Todavía no hay medición. Tras una comprobación, aquí aparece la comparación.',
    gebirgeBrauchtBeide:
  ...
  mitbringen: {
    ...
    liest: 'Extrayendo la pista de audio …',
    dauer: '{{dauer}} s · {{rate}} kHz',
    schieben: 'Desplace el fragmento: en un vídeo la imagen le sigue.',
    ganzKurz: 'Se utilizará toda la grabación.',
    hoeren: '▶ Escuchar fragmento',
    stoppen: '■ Detener',
    verwenden: 'Usar este fragmento',
    andereDatei: 'Elegir otro archivo',
    abbrechen: 'Cancelar',
    fehlerKeineTonspur: 'Este vídeo no tiene pista de audio.',
    fehlerFormat:
      'Este navegador no puede leer este formato. En el teléfono, o en Chrome, Edge y Safari suele funcionar; si no, ayuda una grabación en WAV o WebM.',
    fehlerZuGross:
      'El archivo es demasiado grande ({{zusatz}}). Debe caber entero en memoria: recorte el vídeo o use menor resolución.',
  ...
  maschine: {
    ...
    fingerabdruckFertig: 'El estado normal está listo',
    fingerabdruckAlt: 'Huella acústica de esta máquina',
    aktionGegenprobe: 'Hacer una contraprueba',
    ...
    hinweisGegenprobe:
      'Graba la misma máquina otra vez: verás enseguida qué tan preciso es el comparativo.',
    ...
    ergebnisAbweichung: 'La medición suena distinta al estado normal.',
    ergebnisAehnlich: 'La medición suena como el estado normal.',
    aehnlichkeit: 'Similitud {{wert}} % · {{wann}}',
    trotzdemHoeren: 'Escuchar la comparación de todos modos',
    letzterUnterschied: '🔍 Escuchar la última diferencia',
    briefing: '✨ Informe sonoro',
    verlaufMitZahl: 'Historial · {{anzahl}} pruebas',
    verlaufEine: 'Historial · 1 prueba',
    pruefungKurz: '{{wert}} % · {{wann}}',
    keinTonGespeichert: 'No se guardó audio para esta prueba.',
  ...
  klangbild: {
    quelleFoto: '📷 Foto',
    fotoAlt: 'Foto de posición guardada de esta máquina',
    fotoHinweis: 'Así estaba el dispositivo al aprender: sosténgalo igual.',
    irisLegende: 'Color = intensidad de la frecuencia · línea blanca = estado normal',
  ...
  hoerlupe: {
    ...
    hervorhebungAus: 'Medición original',
    hervorhebungDeutlich: 'Claro',
    hervorhebungStark: 'Fuerte',
    hervorhebungHinweis:
      'Ayuda auditiva procesada. La medición original y la valoración no cambian.',
    hervorhebungDeutlichLaeuft: 'Medición · diferencia resaltada claramente',
    hervorhebungStarkLaeuft: 'Medición · diferencia resaltada con fuerza',
    vergleichTeilen: '📤 Compartir con un especialista',
    vergleichWirdVorbereitet: 'Preparando archivos WAV …',
    vergleichTitel: 'Comparación auditiva SoundFuchs · {{name}}',
    vergleichText:
      'Medición original y ayuda auditiva procesada ({{stufe}}). La ayuda no cambia la valoración.',
    vergleichGeteilt: 'La comparación se envió al menú de compartir.',
    vergleichHeruntergeladen: 'La medición original y la ayuda auditiva se descargaron como WAV.',
    vergleichFehlgeschlagen: 'No se pudo exportar la comparación auditiva.',
    ...
    auswahlHinweisEinzeln:
      'Dibuja un marco alrededor del patrón sospechoso. Ese rango de tiempo y frecuencia se añade al briefing sonoro como ayuda auditiva.',
    ...
    auswahlAchseFrequenz: '↕ Frecuencia',
    auswahlAchseZeit: 'Tiempo →',
    auswahlAnhoeren: '🔊 Escuchar selección',
    auswahlAnhoerenQuelle: '🔊 Escuchar selección de {{quelle}}',
    auswahlNichtVerfuegbar: 'No se puede crear una ayuda auditiva para esta área.',
    auswahlQuelle: 'Selección del espectrograma',
    auswahlBeschreibung: 'Selección {{quelle}} · {{vonZeit}}–{{bisZeit}} s · {{vonHz}}–{{bisHz}}',
    staerkeTitel: 'Intensidad de la desviación acústica',
    staerkeInnerhalb: 'Dentro de la variación normal',
    staerkeLeicht: 'Ligeramente elevada',
    staerkeDeutlich: 'Claramente elevada',
    staerkeStark: 'Fuertemente elevada',
    staerkeAnteil: 'Antes de amplificar: RMS de diferencia al {{prozent}} % de la medición.',
    staerkeVergleich:
      'Antes de amplificar: RMS al {{prozent}} % · {{faktor}}× la variación interna del estado normal.',
    staerkeHinweis:
      'La diferencia se amplifica después para detectarla. Esto describe un cambio acústico, no la gravedad de un daño.',
    laeuft: 'Sonando: {{quelle}}',
  },
  analysisPackage: {
    entryEyebrow: 'Nuevo · local y libre',
    entryTitle: 'Convierte el sonido en un briefing claro',
    entryHint:
      'Estado normal, medición, diferencia marcada y contexto para un especialista o la IA que elijas.',
    entryButton: '✨ Crear briefing sonoro',
    entrySingleEyebrow: '¿Sin referencia? No pasa nada.',
    entrySingleTitle: 'Convierte la sospecha en un briefing sonoro claro',
    entrySingleHint:
      'Original, foco marcado, ayuda auditiva, calidad y un plan para la mejor contragrabación.',
    entrySingleButton: '✨ Crear briefing sonoro',
    eyebrow: 'Asistente sonoro SoundFuchs',
    title: 'Preparar briefing sonoro',
    intro:
      'Describe la situación. SoundFuchs prepara grabación, foco auditivo y contexto para compartirlos, sin subir datos ni pedir una cuenta.',
    ...
    situationHint:
      'Un buen contexto ayuda a especialistas e IA a distinguir un motor, una cocina o un taller.',
    situationVehicle: '🚗 Vehículo · compartimento motor',
    situationHousehold: '🏠 Electrodoméstico · interior',
    situationBuilding: '🔥 Instalaciones · sala técnica',
    situationTool: '🛠️ Herramienta o equipo de jardín',
    situationOther: '✍️ Otra situación',
    vehicleDetails: '¿Qué condiciones se aplican? Puedes elegir varias.',
    hoodOpen: 'capó abierto',
    hoodClosed: 'capó cerrado',
    coldStart: 'arranque en frío',
    warmIdle: 'ralentí en caliente',
    raisedRpm: 'régimen elevado',
    descriptionLabel: '¿Qué debe saber quien lo reciba?',
    descriptionVehiclePlaceholder:
      'Por ejemplo: silbido delante a la derecha, tras 30 minutos, a unas 1.800 rpm …',
    descriptionPlaceholder:
      'Describe brevemente equipo, lugar, funcionamiento y sonido llamativo …',
    dictate: '🎙️ Dictar situación',
    dictating: '● Escuchando — toca para terminar',
    dictationNote:
      'Solo el texto reconocido entra en el briefing. El navegador puede usar su servicio de voz.',
    selectionIncluded: '🎯 Foco marcado incluido: {{from}}–{{to}} s · {{low}}–{{high}} Hz',
    privacyTitle: 'Tú decides qué se incluye',
    privacyText:
      'La ubicación y los datos del cliente no se incluyen. El audio aún puede contener voces o ambiente.',
    includeName: 'Incluir el nombre “{{name}}”',
    consent: 'He comprobado que puedo compartir estos audios con un especialista o una IA externa.',
    localPromise: '🔒 SoundFuchs no sube nada',
    create: 'Descargar briefing + copiar encargo',
    working: 'Preparando el briefing sonoro localmente …',
    failed: 'No se pudo crear el briefing sonoro completo. Inténtalo de nuevo.',
    successTitle: 'Tu briefing sonoro está listo',
    successCopied: 'Se descargó el ZIP y el mismo encargo está en el portapapeles.',
    successFallback: 'Se descargó el ZIP. El encargo está dentro y también puedes copiarlo abajo.',
    successWarnings:
      'No se pudieron crear {{count}} archivo(s) opcional(es); consulta HINWEISE.txt dentro del ZIP.',
    promptBackup: 'Copia de seguridad: revisar y copiar el encargo',
    copyAgain: 'Copiar encargo otra vez',
    copied: '✓ Encargo copiado',
    copyManually: 'Texto seleccionado — cópialo',
    done: 'Listo',
    openIn: 'Abrir en {{name}}',
    openInHint: 'Péguelo allí y adjunte el archivo ZIP descargado. SoundFuchs no sube nada.',
    useInstead: 'Usar {{name}} en su lugar',
  },
  tool: {
    title: 'Herramienta de análisis',
    description:
      'El informe de sonido se crea en el navegador. Adónde lo lleva después lo decide aquí: SoundFuchs abre la herramienta, pero no sube nada.',
    label: 'Herramienta',
    hint: 'Al final del informe, un botón lleva allí. La orden de trabajo queda en el portapapeles y el paquete en la carpeta de descargas.',
  },
  site: {
    countMachines: '{{n}} máquinas',
    countMachineOne: '1 máquina',
    stateNoneChecked: 'ninguna revisada todavía',
    stateDeviating: '{{n}} suenan distinto a su estado normal',
    stateDeviatingOne: '1 suena distinto a su estado normal',
    stateUnchecked: '{{n}} sin estado normal',
    stateUncheckedOne: '1 sin estado normal',
    stateAllFine: 'todas suenan como su estado normal',
  ...
  map: {
    ...
    emptyTitle: 'Empieza con tu primera máquina',
  ...
  customers: {
    ...
    createButton: 'Guardar ubicación',
    created: 'Se ha creado la ubicación «{{name}}».',
    createError: 'No se pudo guardar la ubicación.',
    gpsButton: 'Usar ubicación actual',
    gpsUpdate: 'Actualizar posición GPS',
    gpsLocating: 'Determinando la ubicación …',
  ...
  diagnose: {
    ...
    display: {
      ...
      listenSectionLabel: 'Lupa auditiva',
      listenSectionHint: 'Compara el estado normal y la medición – o escucha solo lo que es nuevo.',
  ...
  about: {
    ...
    checkFound: 'Nueva versión encontrada. Con «Actualizar ahora» SoundFuchs se reinicia.',
  ...
  spectro3d: {
    ...
    sourceReference: 'Estado normal',
    sourceDifference: 'Diferencia',
    sourceSigned: 'Más o menos',
    ansichtenGruppe: 'Qué vista',
    sameTime: '⏱ Mismo intervalo',
    fullTime: '⏱ Grabación completa',
    resetView: 'Restablecer vista',
    compareScale: '⚖ Comparar intensidad',
    detailScale: '🔎 Mostrar detalles',
