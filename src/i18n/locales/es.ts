...
export const es: TranslationDict = {
  ...
  maschine: {
    ...
    hinweisGegenprobe: 'Graba la misma máquina otra vez: verás enseguida qué tan preciso es el comparativo.',
  ...
  diagnose: {
    ...
    display: {
      ...
      listenSectionHint:
        'Compara el estado normal y la medición – o escucha solo lo que es nuevo.',
