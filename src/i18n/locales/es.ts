...
export const es: TranslationDict = {
  ...
  hoerlupe: {
    ...
    auswahlHinweis:
      'Dibuja un marco alrededor del patrón llamativo. Las flechas lo mueven; Mayús + flechas cambia su tamaño. Se reproduce una ayuda auditiva procesada a partir de la diferencia.',
    ...
    auswahlBeschreibung: 'Selección · {{vonZeit}}–{{bisZeit}} s · {{vonHz}}–{{bisHz}}',
