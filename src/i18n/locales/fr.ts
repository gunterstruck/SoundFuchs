...
export const fr: TranslationDict = {
  ...
  hoerlupe: {
    ...
    auswahlHinweis:
      'Tracez un cadre autour du motif remarquable. Les flèches le déplacent ; Maj + flèches modifie sa taille. La lecture est une aide auditive traitée issue de la différence.',
    ...
    auswahlBeschreibung: 'Sélection · {{vonZeit}}–{{bisZeit}} s · {{vonHz}}–{{bisHz}}',
