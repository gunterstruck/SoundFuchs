...
export const fr: TranslationDict = {
  ...
  map: {
    ...
    emptyTitle: 'Commencez avec votre première machine',
  ...
  customers: {
    ...
    createButton: 'Enregistrer le site',
    created: 'Le site « {{name}} » a été créé.',
    createError: 'Le site n’a pas pu être enregistré.',
    gpsButton: 'Utiliser la position actuelle',
    gpsUpdate: 'Actualiser la position GPS',
  ...
  identify: {
    ...
    optionalTitle: 'Informations facultatives',
    optionalHint: 'Site et affectation',
  ...
  about: {
    ...
    intro:
      "<strong>SoundFuchs 2.0</strong> est un <strong>assistant sonore</strong> respectueux de la vie privée. La Progressive Web App enregistre, compare et marque localement les bruits de machines et prépare un <strong>briefing sonore</strong> pour des spécialistes ou une IA externe, sans compte ni cloud d'analyse propre à SoundFuchs.<br><br><strong>SoundFuchs ne pose aucun diagnostic.</strong> Il rend clair ce que l'utilisateur veut montrer ; l'examen et l'interprétation appartiennent au destinataire.",
    ...
    ipTable: {
      ...
      rows: {
        '0': {
          ...
          soundfuchsDiff:
            "SoundFuchs évalue localement, sans cloud d'analyse propre, base centrale de mesures ni diagnostic",
        },
        '1': {
          reference:
        ...
        '3': {
          ...
          soundfuchsDiff:
            "SoundFuchs crée des profils de référence et des similarités locales, mais n'entraîne aucun réseau neuronal propre et ne détermine aucune cause de panne",
        },
        '4': {
          reference:
    ...
    checkFound: 'Nouvelle version trouvée. « Mettre à jour maintenant » redémarre SoundFuchs.',
  ...
  quickCompare: {
    ...
    wizard: {
      ...
      explanation:
        'Allez à chaque machine l’une après l’autre et enregistrez-la. Le premier enregistrement devient la base de comparaison pour toutes les autres — faites-le sur une machine qui vous semble sans particularité.',
      next: 'Next',
    ...
    reference: {
      ...
      hint: 'Cet enregistrement devient la base de comparaison pour toutes les autres machines.',
      startRecording: "Enregistrer l'état normal",
    ...
    result: {
      ...
      notChecked: 'Not checked',
      basisVerdaechtig:
        'Toutes les machines contrôlées s’écartent de la base de comparaison. La base elle-même peut alors être la machine remarquable — enregistrez-la sur une autre machine.',
