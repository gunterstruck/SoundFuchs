...
export const zh: TranslationDict = {
  ...
  hoerlupe: {
    ...
    auswahlHinweisEinzeln: '框选可疑模式。这个时间和频率范围会作为听觉辅助加入声音案例。',
  ...
  analysisPackage: {
    ...
    entryTitle: '把声音整理成清晰案例',
    entryHint: '将正常状态、测量、差异、情境和频谱图交给你选择的 AI。',
    entryButton: '✨ 创建 AI 分析包',
    entrySingleEyebrow: '没有参考录音？没关系。',
    entrySingleTitle: '把怀疑整理成清晰的声音案例',
    entrySingleHint: '包括原始录音、标记重点、听觉辅助、录音质量和下一次对照录音计划。',
    entrySingleButton: '✨ 为 AI 创建声音案例',
    eyebrow: 'SoundFuchs 交接助手',
    title: '清楚地传递声音',
    intro: '描述录音情境。SoundFuchs 在本地生成可追溯的分析包，无需上传或账户。',
    ...
    situationHint: '良好的情境能避免 AI 混淆发动机舱、厨房或车间。',
    ...
    consent: '我已确认可以把这些音频文件交给外部 AI。',
    localPromise: '🔒 SoundFuchs 不上传任何内容',
    create: '下载分析包并复制提示词',
    working: '正在本地生成分析包……',
    failed: '无法生成完整分析包，请重试。',
    successTitle: '案例已准备好',
    successCopied: 'ZIP 已下载，相同的分析提示词也已复制到剪贴板。',
    successFallback: 'ZIP 已下载。提示词安全地保存在包内，也可在下方复制。',
    successWarnings: '{{count}} 个可选文件未能生成；详情见 ZIP 内的 HINWEISE.txt。',
    promptBackup: '双重保障：查看并复制提示词',
    copyAgain: '再次复制提示词',
    copied: '✓ 已复制提示词',
