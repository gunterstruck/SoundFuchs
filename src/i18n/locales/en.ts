...
export const en: TranslationDict = {
  ...
  hoerlupe: {
    ...
    auswahlHinweis:
      'Drag a frame around the conspicuous pattern. Arrow keys move it; Shift + arrow keys resize it. Playback is a processed listening aid made from the difference.',
    ...
    auswahlBeschreibung: 'Selection · {{vonZeit}}–{{bisZeit}} s · {{vonHz}}–{{bisHz}}',
