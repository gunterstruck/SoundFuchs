...
export const en: TranslationDict = {
  ...
  maschine: {
    ...
    hinweisGegenprobe: 'Record the same machine again — you will see right away how precise the comparison is.',
  ...
  diagnose: {
    ...
    display: {
      ...
      listenSectionHint:
        'Compare the normal state and the measurement – or hear only what is new.',
